...
if (isset($_POST['sub'])) {
    $name = $_POST['email'];
    $resul = $con->query("SELECT * FROM tblsubscriber WHERE Email = '$name'");
    if ($resul->num_rows > 0) {
        echo "<script>alert('Email is already subscribed')</script>";
    } else {
        ...
        try {
            ...
            //Recipients
            $mail->setFrom('abhishek16333@gmail.com', 'Meraki Salon');
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="copyright-content">
                            <p><i class="fa fa-copyright"></i> Meraki Salon Management System 2024 || Created by
                                <span>Russel M. Giducos</span>
                            </p>
                        </div>
                    </div>
                </div>
