			...
			<div id="page-wrapper" style="min-height: 562px;">
				<div class="main-page login-page ">
					...
					<div class="widget-shadow">
						<div class="login-top">
							<h4>Welcome back to Meraki's Salon AdminPanel </h4>
						</div>
						<div class="login-body">
							<form role="form" method="post" action=""> <input type="text" class="user" name="username"
									placeholder="Username" required="true"> <input type="password" name="password" class="lock"
									placeholder="Password" required="true"> <input type="submit" name="login" value="Sign In">
								<div class="forgot-grid">
									<div class="forgot"> <a href="../index.php">Back to Home <i class="fa fa-backward"></i></a> </div>
									<div class="clearfix"> </div>
								</div>
								<div class="forgot-grid">
									<div class="forgot_pass"> <a href="forgot-password.php">Forgot Password <i
