...
<body class="cbp-spmenu-push">
  <div class="main-content">
          ...
          <ul class="nav" id="leftCol" style="margin-top:7%;background: #1e1e1e;">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-content nav nav-second-level collapse">
                ...
                <li>
                  <a href="sales-reports.php" class="chart-nav"><i class="fa fa-file-text-o nav_icon"></i>Sales
                    Report</a>
                </li>
              </ul>
            </li>
          ...
          <ul class="nofitications-dropdown">
            ...
            <li class="dropdown head-dpdn">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i
                  class="fa fa-bell"></i><span class="badge blue">0</span></a>
    ...
    <!--footer-->
    <div class="footer">
      <p>&copy; 2024 Meraki's Salon Management System Admin Panel || Created by Russel Giducos</p>
    </div>
    <!--//footer--> <!--//footer-->
  </div>
  <!-- Classie -->
