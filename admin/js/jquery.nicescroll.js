	...
	var A = window.MutationObserver || window.WebKitMutationObserver || !1,
		...
		Q = function (h, c) {
			...
			function t(d, c, f) {
				var g, e;
				0 == d.deltaMode
					? ((g = -Math.floor(d.deltaX * (b.opt.mousescrollstep / 54))), (e = -Math.floor(d.deltaY * (b.opt.mousescrollstep / 54))))
					: 1 == d.deltaMode && ((g = -Math.floor(d.deltaX * b.opt.mousescrollstep)), (e = -Math.floor(d.deltaY * b.opt.mousescrollstep)));
			...
			this.init = function () {
				...
				if (!b.ispage || (!g.cantouch && !g.isieold && !g.isie9mobile)) {
					...
					b.opt.boxzoom &&
						...
						(b.zoom = e(c)),
						b.zoom.css({ cursor: "pointer", "z-index": b.zindex, backgroundImage: "url(" + N + "zoomico.png)", height: 18, width: 18, backgroundPosition: "0px 0px" }),
					...
					b.ispage
						...
						: (b.ishwscroll
								? ("static" == b.win.css("position") && b.css(b.win, { position: "relative" }),
								  ...
								  b.zoom && (b.zoom.css({ position: "absolute", top: 1, right: 0, "margin-right": f.width + 4 }), d.append(b.zoom)),
								...
								: ((b.isfixed = "fixed" == b.win.css("position")),
								  ...
								  b.viewport && ((b.body = b.viewport), !1 == /fixed|relative|absolute/.test(b.viewport.css("position")) && b.css(b.viewport, { position: "relative" })),
								  f.css({ position: d }),
						...
						if (g.cantouch || b.istouchcapable || b.opt.touchbehavior || g.hasmstouch) {
							...
							b.ontouchend = function (d) {
								...
								if (
									b.rail.drag &&
									2 == b.rail.drag.pt &&
									(b.scrollmom.doMomentum(), (b.rail.drag = !1), b.hasmoving && ((b.hasmoving = !1), (b.lastmouseup = !0), b.hideCursor(), g.hasmousecapture && document.releaseCapture(), !g.cantouch))
								)
									return b.cancelEvent(d);
							};
								...
								if (b.rail.drag && 2 == b.rail.drag.pt) {
									...
									b.synched("touchmove", function () {
										b.rail.drag &&
											...
											b.railh && b.railh.scrollable ? (b.setScrollLeft(m), b.showCursor(r, m)) : b.showCursor(r),
			...
			this.showCursor = function (d, c) {
				...
				if (b.rail) {
					...
					b.cursorh &&
						(!b.rail.align && b.rail.visibility ? b.cursorh.css({ width: b.cursorwidth, left: b.scroll.x + b.rail.width }) : b.cursorh.css({ width: b.cursorwidth, left: b.scroll.x }),
						(b.cursoractive = !0));
			...
			this.bind = function (d, c, f, e) {
				...
				"mousewheel" == c
					? "onwheel" in b.win
						...
						: ((d = "undefined" != typeof document.onmousewheel ? "mousewheel" : "DOMMouseScroll"), q(k, d, f, e || !1), "DOMMouseScroll" == d && q(k, "MozMousePixelScroll", f, e || !1))
					: k.addEventListener
					? (g.cantouch &&
					  ...
					  (this.doScrollPos = function (c, e, f) {
							...
							b.timer = setTimeout(function () {
								...
								0 < l &&
									(!b.scrollrunning &&
										b.onscrollstart &&
										b.onscrollstart.call(b, { type: "scrollstart", current: { x: k, y: f }, request: { x: c, y: e }, end: { x: b.newscrollx, y: b.newscrolly }, speed: l }),
									g.transitionend
										? b.scrollendtrapped || ((b.scrollendtrapped = !0), b.bind(b.doc, g.transitionend, b.onScrollEnd, !1))
										: (b.scrollendtrapped && clearTimeout(b.scrollendtrapped), (b.scrollendtrapped = setTimeout(b.onScrollEnd, l))),
									(b.timerscroll = { bz: new BezierClass(f, b.newscrolly, l, 0, 0, 0.58, 1), bh: new BezierClass(k, b.newscrollx, l, 0, 0, 0.58, 1) }),
									b.cursorfreezed ||
					...
					: ((this.doScrollLeft = function (c, g) {
					  ...
					  (this.doScrollPos = function (c, g, f) {
							...
							if (!b.timer) {
								...
								b.onscrollstart &&
									!b.scrollrunning &&
									b.onscrollstart.call(b, { type: "scrollstart", current: { x: l, y: k }, request: { x: c, y: g }, end: { x: b.newscrollx, y: b.newscrolly }, speed: h });
								e();
