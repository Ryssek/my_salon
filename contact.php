...
<head>
    ...
    <title>Meraki Salon Management System || Contact Page</title>
    <!-- Bootstrap -->
...
<body>
    ...
    <div style="overflow:hidden;resize:none;max-width:100%;width:1500px;height:500px;">
        <div id="my-map-display" style="height:100%; width:100%;max-width:100%;"><iframe
                ...
                src="https://www.google.com/maps/embed/v1/place?q=Meraki+salon+and+spa&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"></iframe>
