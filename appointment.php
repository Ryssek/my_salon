...
if (strlen($_SESSION['loggedin'] == false)) {
	...
	<head>
		...
		<title>Meraki Salon Management System || Home Page</title>
		<!-- Bootstrap -->
						...
						<div class="form-body">
							<form method="post">
								...
								<div class="form-group mobile-input">
									...
									<input type="text" class="form-control" id="mobilenum" name="mobilenum" placeholder="Mobile Number"
										value="" required="true" maxlength="11" pattern="[0-9]+">
								</div>
								...
								<div class="form-group service-input">
									...
									<input type="date" class="form-control" name="date" placeholder="Date" name="adate" id="adate"
										required="true" min="<?php echo date('Y-m-d'); ?>">
								</div>

								<div class="form-group service-input">
									<label for="details">Appointment Time</label>
									<input type="time" class="form-control" name="time" placeholder="Time" name="atime" id='atime'
										required="true">
								</div>
								...
								<div class="form-group service-input">
									...
									<p style="font-style: italic;">Please enter valid services listed on <a href="service-list.php">Services
											Page</a>
									</p>
